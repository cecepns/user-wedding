...
const AdminServiceFeatures = () => {
  ...
  const fetchFeatures = async () => {
    try {
      ...
      const response = await fetch(
        "https://api.kingcreativestudio.my.id/user-wedding/api/service-features",
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingFeature
        ? `https://api.kingcreativestudio.my.id/user-wedding/api/service-features/${editingFeature.id}`
        : "https://api.kingcreativestudio.my.id/user-wedding/api/service-features";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("adminToken");
      const response = await fetch(
        `https://api.kingcreativestudio.my.id/user-wedding/api/service-features/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
