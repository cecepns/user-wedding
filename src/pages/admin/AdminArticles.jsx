...
const AdminArticles = () => {
  ...
  const handleSubmit = async (articleData) => {
    try {
      const url = editingArticle 
        ? `https://api-inventory.isavralabel.com/user-wedding/api/articles/${editingArticle.id}`
        : 'https://api-inventory.isavralabel.com/user-wedding/api/articles';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://api-inventory.isavralabel.com/user-wedding/api/articles/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
