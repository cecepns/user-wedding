...
const AdminArticles = () => {
  ...
  const fetchArticles = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-wedding/api/articles');
  ...
  const handleSubmit = async (articleData) => {
    try {
      const url = editingArticle 
        ? `https://api.kingcreativestudio.my.id/user-wedding/api/articles/${editingArticle.id}`
        : 'https://api.kingcreativestudio.my.id/user-wedding/api/articles';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-wedding/api/articles/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
