...
const AdminPayments = () => {
  ...
  const fetchPaymentMethods = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-wedding/api/payment-methods');
  ...
  const handleSubmit = async (methodData) => {
    try {
      const url = editingMethod 
        ? `https://api.kingcreativestudio.my.id/user-wedding/api/payment-methods/${editingMethod.id}`
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-wedding/api/payment-methods/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
