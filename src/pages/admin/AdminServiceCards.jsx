...
const AdminServiceCards = () => {
  ...
  const fetchCards = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-wedding/api/service-cards', {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingCard 
        ? `https://api.kingcreativestudio.my.id/user-wedding/api/service-cards/${editingCard.id}`
        : 'https://api.kingcreativestudio.my.id/user-wedding/api/service-cards';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://api.kingcreativestudio.my.id/user-wedding/api/service-cards/${id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('admin_token')}`
        }
