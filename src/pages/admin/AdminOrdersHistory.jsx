...
const AdminOrdersHistory = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.kingcreativestudio.my.id/user-wedding/api/orders?page=${ordersPagination.page}&limit=${ordersPagination.limit}&status=confirmed,completed,cancelled`,
        {
          headers: {
  ...
  const handleStatusUpdate = async (orderId, newStatus) => {
    try {
      const response = await fetch(
        `https://api.kingcreativestudio.my.id/user-wedding/api/orders/${orderId}/status`,
        {
          method: "PUT",
          headers: {
  ...
  const handleDeleteOrder = async (orderId) => {
    ...
    try {
      const response = await fetch(
        `https://api.kingcreativestudio.my.id/user-wedding/api/orders/${orderId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("admin_token")}`,
