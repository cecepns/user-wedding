...
const Home = () => {
  ...
  const fetchHeroContent = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-wedding/api/content-sections/hero_section');
      if (response.ok) {
  ...
  const fetchServicesContent = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-wedding/api/content-sections/services_preview_section');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchServiceCards = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-wedding/api/service-cards?card_type=service');
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchCtaContent = async () => {
    try {
      const response = await fetch('https://api.kingcreativestudio.my.id/user-wedding/api/content-sections/home_cta_section');
      if (response.ok) {
        const data = await response.json();
        setCtaContent(data);
      }
