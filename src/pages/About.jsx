...
const About = () => {
  ...
  const fetchAboutContent = async () => {
    try {
      ...
      const heroResponse = await fetch('https://api-inventory.isavralabel.com/user-wedding/api/content-sections/about_hero_section');
      if (heroResponse.ok) {
      ...
      const missionResponse = await fetch('https://api-inventory.isavralabel.com/user-wedding/api/content-sections/about_mission_section');
      ...
      const ctaResponse = await fetch('https://api-inventory.isavralabel.com/user-wedding/api/content-sections/about_cta_section');
      if (ctaResponse.ok) {
  ...
  const fetchAboutCards = async () => {
    try {
      const response = await fetch('https://api-inventory.isavralabel.com/user-wedding/api/service-cards?card_type=about');
      if (response.ok) {
